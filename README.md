...
| 2. 긍정 활동 | 기분 좋았거나 만족스러웠던 활동 기록 | 최소 1개, 최대 10개 |
| 3. 부정 활동 | 기분 안 좋았거나 불만족스러웠던 활동 기록 | 최소 1개, 최대 10개 |
| 4. 배경조사 | 성별, 학교 소재지, 학교 유형, 진로 결정 여부 | 선택적 (이미 응답 시 건너뛰기 가능) |
...
- [구현 계획서 (Implementation Plan)](docs/implementation_plan.md)
- [테스트 결과 (Test Results)](docs/test_results.md)
